...
Page({
  ...
  tuoguan1(){
    this.setData({tg1:1});
    if(this.data.tg1&&this.data.tg2){
      wx.showToast({
        title: '不能再托管了',
        icon:"none",
        duration:2000
    ...
    if(this.data.flag%2) this.P1tuoguan();
  ...
  tuoguan2(){
    ...
    if(this.data.flag%2-1) this.P2tuoguan();
  ...
  judgetuoguan(){
    if(this.data.tg1)this.P1tuoguan();
    if(this.data.tg2)this.P2tuoguan();
  },
